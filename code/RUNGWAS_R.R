...
#   batch_size        = 20000,
#   output_prefix     = paste0(path, fname, "_", phenotype, "_", paste(cov_, collapse="_"), "_glm_", model)
# )

## No covariates example
...
results <- run_gwas(
  ...
  regression_type   = model,
  batch_size        = 20000,
  output_prefix     = paste0(path, sbpath,fname, "_", phenotype, "_", paste(cov_, collapse="_"), "_glm_", model)
)
